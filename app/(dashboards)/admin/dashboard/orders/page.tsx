...
export default async function AdminOrders({
  ...
  // Note: Some orders may have deleted products, so we need to handle null products
  ...
  // Map orders to handle null products gracefully
  const orders = ordersRaw.map((order) => ({
    ...order,
    product: order.product || {
      name: order.productName || "Deleted Product",
      images: [],
    },
  }));
  ...
  const statusCounts = {
    ...
    pending_transfer: orders.filter((o) => o.status === "PENDING_TRANSFER")
      .length,
  ...
  return (
    <PermissionGate requiredPermission="MANAGE_ORDERS">
