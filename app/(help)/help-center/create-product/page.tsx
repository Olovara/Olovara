...
export const metadata: Metadata = {
  ...
  description: "Complete step-by-step guide to creating your first product listing on Yarnnu. Learn about photos, descriptions, pricing, and optimization.",
}
...
const productSteps = [
  {
    ...
    description: "Create compelling visual content that showcases your handmade item",
    details: [
  ...
  },
  {
    ...
    description: "Write detailed, accurate information about your handmade item",
    details: [
  ...
  },
  {
    ...
    description: "Set competitive pricing that reflects your craftsmanship and costs",
    details: [
  ...
  },
  {
    ...
    description: "Help customers find your product through proper categorization",
    details: [
...
const commonMistakes = [
  {
    ...
    description: "Blurry, dark, or unclear images that don't showcase your product properly",
    solution: "Invest time in good photography - it's often the first thing customers see"
  },
  {
    mistake: "Vague Descriptions",
    description: "Generic descriptions that don't highlight what makes your item unique",
    solution: "Be specific about materials, techniques, and unique features"
  },
  {
    mistake: "Incorrect Pricing",
    description: "Pricing too low (undervaluing your work) or too high (pricing out your market)",
    solution: "Research your market and calculate all costs including your time"
  },
  {
    mistake: "Wrong Categories",
    description: "Placing items in incorrect or too broad categories",
    solution: "Choose the most specific category that accurately describes your item"
  },
  {
    mistake: "Missing Information",
    description: "Leaving out important details like dimensions, materials, or care instructions",
    solution: "Think like a customer - what would you want to know before buying?"
  }
]
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <p className="text-lg text-gray-600">
          Complete step-by-step guide to creating compelling product listings on Yarnnu. Learn how to showcase your 
          handmade items with professional photos, compelling descriptions, and optimal pricing.
        </p>
      </div>
      ...
      <Alert className="border-purple-200 bg-purple-50">
        ...
        <AlertDescription className="text-purple-800">
          <strong>Product Creation Timeline:</strong> Plan for 1-2 hours to create your first product listing. 
          Quality photos and descriptions are crucial for attracting customers and making sales.
        </AlertDescription>
      </Alert>

      {/* Essential Elements */}
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-900">Essential Product Elements</h2>
        <p className="text-gray-600">
          These elements are crucial for creating successful product listings that convert browsers into buyers:
        </p>
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <span className={`text-xs px-2 py-1 rounded-full ${
                      element.importance === 'Critical' ? 'bg-red-100 text-red-700' :
                      element.importance === 'High' ? 'bg-yellow-100 text-yellow-700' :
      ...
      {/* Photo Guidelines */}
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-900">Photo Guidelines</h2>
        <p className="text-gray-600">
          Professional photos are essential for showcasing your handmade items and attracting customers:
        </p>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {photoGuidelines.map((guideline) => (
            <div key={guideline.requirement} className="border border-gray-200 rounded-lg p-4 hover:border-purple-300 transition-colors">
              <div className="flex items-start space-x-3">
                <Camera className="h-5 w-5 text-purple-600 mt-0.5 flex-shrink-0" />
                <div className="flex-1">
                  <h3 className="font-medium text-gray-900 mb-1">{guideline.requirement}</h3>
      ...
      <div className="space-y-6">
        <h2 className="text-2xl font-semibold text-gray-900">Product Creation Process</h2>
      ...
      {/* Optimization Tips */}
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-900">Product Optimization Tips</h2>
        <p className="text-gray-600">
          These strategies will help your products stand out and attract more customers:
        </p>
      ...
      {/* Common Mistakes */}
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-900">Common Product Creation Mistakes</h2>
        <p className="text-gray-600">
        ...
        <div className="space-y-4">
          {commonMistakes.map((mistake) => (
            <div key={mistake.mistake} className="border border-red-200 bg-red-50 rounded-lg p-4 hover:border-red-300 transition-colors">
              <div className="flex items-start space-x-3">
                <AlertCircle className="h-5 w-5 text-red-600 mt-0.5 flex-shrink-0" />
                <div>
                  <h3 className="font-medium text-red-900">{mistake.mistake}</h3>
      ...
      <div className="bg-gradient-to-r from-purple-50 to-purple-100 border border-purple-200 rounded-lg p-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Ready to Create Your First Product?</h2>
        <p className="text-gray-600 mb-4">
          Now that you understand the product creation process, you&apos;re ready to showcase your handmade items 
          with professional listings that attract customers and drive sales.
        </p>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-sm text-gray-600 mt-1">Set up shipping options and rates for your products</p>
          </Link>
          <Link 
          ...
          >
            ...
            <p className="text-sm text-gray-600 mt-1">Advanced tips for taking professional product photos</p>
          </Link>
        </div>
      </div>
    </div>
