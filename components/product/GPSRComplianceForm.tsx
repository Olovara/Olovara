    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold">Product Safety & Compliance</h3>
          {isRequired && (
        ...
        <p className="text-sm text-gray-600">
          Help ensure your product meets safety standards and regulatory
          requirements.
          {isRequired && (
      ...
      <div className="space-y-2">
        ...
        />
        <p className="text-sm text-gray-600">
          Include any potential hazards, age restrictions, or safety
          precautions.
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        />
        <p className="text-sm text-gray-600">
          Be specific about materials, especially for items that may come into
          contact with skin or be ingested.
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        />
        <p className="text-sm text-gray-600">
          Include information about dyes, finishes, or other chemical
          treatments.
        </p>
      </div>
          ...
          <Alert className="mt-3">
            ...
            <AlertDescription className="text-sm">
              ...
              <p className="mt-2 text-xs">
                These requirements help ensure compliance with EU General
                Product Safety Regulation (GPSR) and protect your customers
                while reducing liability risks.
              </p>
            </AlertDescription>
          </Alert>
        )}
