...
export async function generateMetadata({ searchParams }: ShopsPageProps): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [
      ...
      "artisan shops",
      ...values.map(v => `${v.replace(/([A-Z])/g, ' $1').toLowerCase()} shops`)
    ],
    openGraph: {
      title,
      description,
          ...
          {shops.length === 0 && (
            <div className="text-center py-12">
              <div className="max-w-2xl mx-auto">
                <h2 className="text-2xl font-semibold mb-4">Discover Amazing Artisan Shops</h2>
                <p className="text-gray-600 mb-6">
                  We&apos;re constantly adding new talented artisans to our marketplace. Check back soon to discover unique handmade products from creators around the world.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-500">
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <h3 className="font-medium mb-2">Woman-Owned Businesses</h3>
                    <p>Support female entrepreneurs and their creative ventures</p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <p>Discover one-of-a-kind pieces you won&apos;t find elsewhere</p>
                  </div>
                </div>
              </div>
            </div>
