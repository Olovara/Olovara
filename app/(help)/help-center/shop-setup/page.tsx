...
const shopSetupSteps = [
  {
    ...
    details: [
      ...
      "Set your shop location and shipping origin"
    ],
    tips: [
      ...
      "Accurate location helps with shipping calculations and customer trust"
    ],
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <p className="text-lg text-gray-600">
          Complete guide to creating and customizing your shop profile on Yarnnu. Learn how to build a professional, 
          discoverable shop that attracts customers and builds trust.
        </p>
      </div>
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-900">Essential Shop Elements</h2>
        <p className="text-gray-600">
          Your shop profile consists of several key elements that work together to create a professional, 
          trustworthy presence on Yarnnu:
        </p>
      ...
      {/* Optimization Tips */}
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-900">Shop Optimization Tips</h2>
        <p className="text-gray-600">
          These strategies will help you create a shop that attracts customers and builds lasting relationships:
        </p>
      ...
      {/* Common Mistakes */}
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-900">Common Shop Setup Mistakes</h2>
        <p className="text-gray-600">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <p className="text-gray-600 mb-4">
          ...
          discoverable shop that will attract customers and build lasting relationships.
        </p>
